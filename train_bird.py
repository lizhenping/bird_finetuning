...
def main() -> None:
    ...
    # os.environ["WANDB_MODE"] = "offline" # 模式调为离线
    ...
    if not args.arg_paths:
        ...
        for task, arg_path in args.arg_paths:
            ...
            print(f"Attempting to load dataset from: {task_args.dataset.loader_path}")
            print(f"Cache will be stored at: {task_args.dataset.data_store_path}")
